...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    int carID = 5; // 화면과 연결할 carID 값으로 변경
    ...
    <div class="carimage">
        <div class="carimage_img1">
            <img src="camcar/sola/1.jpeg" alt="">
        </div>
        <div class="carimage_img2">
            <img src="camcar/sola/2.jpeg" alt="">
        </div>
        <div class="carimage_img3">
            <img src="camcar/sola/3.jpeg" alt="">
        </div>
    </div>
    <div class="carimage2">
        ...
        <div class="carimage2_img5">
            <img src="camcar/sola/4.jpeg" alt="">
        </div>
        <div class="carimage2_img6">
            <img src="camcar/sola/5.jpeg" alt="">
    ...
    <div class="carsection">
        <div class="carsection_text">
            ...
            <p>[쏠라티 차량정보]</p>
            <p>* 현대자동차에서 제작한 유럽식 럭셔리 캠핑카, 쏠라티!</p>
            <p>* 압도적인 주행질감과 유럽식 LCV를 기반으로 제작된 럭셔리 캠핑카</p>
            <p>* 4인 의자 테이블, 2층 침대, 싱크대, 화장실, 냉장고</p>

            
            <p><span class="material-symbols-outlined">person</span> 동승가능인원: 4명 <span class="material-symbols-outlined">person</span> 취침가능인원: 4명</p>
            <p><span class="material-symbols-outlined">schedule</span> 대여일 출차시간 11:00~16:00 <span class="material-symbols-outlined">schedule</span> 반납일 반납시간 11:00~16:00</p>
            ...
            <p><i class="fa-solid fa-location-dot fa-lg" style="color: #000000;"></i> 차고지 주소: 대한민국 부산광역시 해운대구 송정동</p>
            <h2>딜리버리(탁송) 가능지역</h2>
            <p>딜리버리 불가능</p>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="profile-tab-pane1" role="tabpanel" aria-labelledby="profile-tab1" tabindex="1">
                 ...
                 <img src="camcar/sola/sola.png" style="width: 100%; height: 100%; margin-top:30px;" alt="">
                  
                  <h2 style="margin-top: 10%">차고지 위치</h2>
    <div class="carlocate" style="width: 602px;height: 520px;">
            <div class="carlocatemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13043.843106804174!2d129.18043381936198!3d35.18253013990407!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35688c46345a3903%3A0xd3eddb94b74f9a52!2z67aA7IKw6rSR7Jet7IucIO2VtOyatOuMgOq1rCDshqHsoJXrj5k!5e0!3m2!1sko!2skr!4v1692720321169!5m2!1sko!2skr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <p style="font-size: 16px; width: 500px;"><i class="fa-solid fa-location-dot fa-lg " style="color: #000000;"></i> 대한민국 부산광역시 해운대구 송정동</p>
        </div>
    </div>
    <div>
                ...
                <div id="carouselExample" class="carousel slide" >
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="camcar/sola/1.jpeg" class="d-block w-100" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/sola/2.jpeg" class="d-block w-100" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/sola/3.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/sola/4.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/sola/5.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/sola/6.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/sola/7.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                    </div>
