...
<div class="carimage">
    <div class="carimage_img1">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/jn2.jpg" alt="">
    </div>
    <div class="carimage_img2">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/n1.jpeg" alt="">
    </div>
    <div  class="carimage_img3">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/n2.jpeg" alt="">
    </div>
</div>
<div class="carimage2">
    ...
    <div class="carimage2_img5">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/n3.jpeg" alt="">
    ...
    <div class="cartext">
        <div class="carimage_text">
            <h2 style="margin-top: 20px; color: #000000; font-family: 'KOTRA_BOLD-Bold';">사구어촌체험마을</h2>
        </div>
    ...
    <div class="carsection">
        <div class="carsection_text">
            <h2><i class="fa-solid fa-toilet"></i> 근처 화장실 있음 </h2>
            <h2 style="margin-top: 5%;">요약설명</h2>
            <p>바지락, 낙지 체험등을 할 수 있는 마을입니다. 밤낚시체험 등 다양한 체험을 제공하나 분기별로 다르기 때문에 예약 확인을 하고 가시길 추천드립니다. 사구어촌체험마을 링크 : http://www.xn--2e0bk8uflfirfg6bu8mura767c.kr/</p>
            
    <h2 style="margin-top: 5%;">위치</h2>
    <div class="carlocate">
            <div class="carlocatemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3295.140590561322!2d126.58068730000001!3d34.3214388!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35731e69df2d45e7%3A0x8594566e23f95b08!2z7KCE652864Ko64-EIO2VtOuCqOq1sCDshqHsp4DrqbQg7IKs6rWs66-46ri4IDIw!5e0!3m2!1sko!2skr!4v1692762224291!5m2!1sko!2skr" width="1200" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <p><i class="fa-solid fa-location-dot fa-lg" style="color: #000000;"></i> 대한민국 전라남도 해남군 송지면 사구미길 20</p>
        </div>
    </div>
    ...
    <p>http://www.xn--2e0bk8uflfirfg6bu8mura767c.kr/</p>
        </div>
        </div>
     <!-- 모달 -->
                    ...
                    <div id="carouselExample" class="carousel slide" >
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="chabakmap/jn/jn2.jpg" class="d-block w-100" alt="Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/n1.jpeg" class="d-block w-100" alt="Image 2">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/n2.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/n3.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
