...
<div class="carimage">
    <div class="carimage_img1">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/jn1.jpg" alt="">
    </div>
    <div class="carimage_img2">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/b1.png" alt="">
    </div>
    <div  class="carimage_img3">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/b2.png" alt="">
    </div>
</div>
<div class="carimage2">
    ...
    <div class="carimage2_img5">
        <img style="width: 100%; height: 100%;" src="chabakmap/jn/b3.png" alt="">
    ...
    <div class="cartext">
        <div class="carimage_text">
            <h2 style="margin-top: 20px; color: #000000; font-family: 'KOTRA_BOLD-Bold';">곡성 압록유원지</h2>
        </div>
    ...
    <div class="carlocate">
            <div class="carlocatemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3260.688009802159!2d127.36998337644356!3d35.18932787275002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x356e1f4c1f9e83d1%3A0x82352694ff1682f1!2z7KCE652864Ko64-EIOqzoeyEseq1sCDso73qs6HrqbQg7ZWY7ZWc66asIDEwMzk!5e0!3m2!1sko!2skr!4v1692761995172!5m2!1sko!2skr" width="1200" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <p><i class="fa-solid fa-location-dot fa-lg" style="color: #000000;"></i> 대한민국 전라남도 곡성군 죽곡면 하한리 1039</p>
        </div>
    </div>
    ...
    <p>https://blog.naver.com/4bubuss/222489923717</p>
        </div>
        </div>
    <!-- 모달 -->
                    ...
                    <div id="carouselExample" class="carousel slide" >
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="chabakmap/jn/jn1.jpg" class="d-block w-100" alt="Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/b1.png" class="d-block w-100" alt="Image 2">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/b2.png" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/b3.png" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/b4.png" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/b5.png" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/jn/b6.png" class="d-block w-100" alt="Image 3">
                            </div>
