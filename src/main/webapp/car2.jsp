...
<body>
    ...
    int carID = 2; // 화면과 연결할 carID 값으로 변경
    ...
    <div class="carimage">
        <div class="carimage_img1">
            <img src="camcar/d2oa5ziw9nemkcgsuy7vf4hl3pxrt0q8-1920x1920.jpg" alt="">
        </div>
        <div class="carimage_img2">
            <img src="camcar/minikhan/IMG_20210610_165201_485.jpg" alt="">
        </div>
        <div class="carimage_img3">
            <img src="camcar/minikhan/IMG_20210610_165201_599.jpg" alt="">
        </div>
    </div>
    <div class="carimage2">
        ...
        <div class="carimage2_img5">
            <img src="camcar/minikhan/3.jpeg" alt="">
        </div>
        <div class="carimage2_img6">
            <img src="camcar/minikhan/4.jpeg" alt="">
    ...
    <div class="carsection">
        <div class="carsection_text">
            ...
            <p>- 레이 기반의 프리미엄 완성형 캠핑카(2021년 4월 출고 신차)</p>
            <p>- 상부 팝업 텐트에서 1명 취침 + 차량 내 평탄화 매트리스 위에서 2명 취침 가능</p>
            <p>- 내부에서 이동할 수 있는 출고 장착형 팝업 텐트</p>
            <p>- 무시동 히터로 내부 및 팝업 텐트까지 완벽 난방</p>
            <p>- 접이식 침상 및 오염방지 특수매트리스 제공으로 안락한 취침</p>
            <p>- 변환식 수전과 이동형 급수(25L) 시스템으로 간단한 세척과 취사 준비 가능</p>
            <p>- 주행 충전 장치 및 100A 파워뱅크 장착, 12V 시가잭, USB 포트 제공으로 다양한 전기장치 활용 가능</p>
            <p>- 프리미엄급 어닝 및 어닝등 장착으로 외부활동 시, 별도의 그늘막 필요 없음</p>

            
            <p><span class="material-symbols-outlined">person</span> 동승가능인원: 2명 <span class="material-symbols-outlined">person</span> 취침가능인원: 2명</p>
            ...
            <p><i class="fa-solid fa-location-dot fa-lg" style="color: #000000;"></i> 차고지 주소: 대한민국 경기도 김포시 고촌읍 신기신동로 44</p>
            <h2>딜리버리(탁송) 가능지역</h2>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                 ...
                 <img src="camcar/minikhan/minikhan2_2.png" style="width: 100%; height: 100%; margin-top:30px;" alt="">
                  
                  <h2 style="margin-top: 10%">차고지 위치</h2>
    <div class="carlocate" style="width: 602px;height: 520px;">
            <div class="carlocatemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3160.6834588992715!2d126.77321049999999!3d37.60960819999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357c84b717ef8567%3A0x2b080cf7b74f0a9c!2z6rK96riw64-EIOq5gO2PrOyLnCDqs6DstIzsnY0g7Iug6riw7Iug64-Z66GcIDQ0!5e0!3m2!1sko!2skr!4v1692671344823!5m2!1sko!2skr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    ...
                    <div id="carouselExample" class="carousel slide" >
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="camcar/d2oa5ziw9nemkcgsuy7vf4hl3pxrt0q8-1920x1920.jpg" class="d-block w-100" alt="Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="camcar/minikhan/IMG_20210610_165201_485.jpg" class="d-block w-100" alt="Image 2">
                            </div>
                            <div class="carousel-item">
                                <img src="camcar/minikhan/IMG_20210610_165201_599.jpg" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="camcar/minikhan/3.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="camcar/minikhan/4.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="camcar/minikhan/5.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="camcar/minikhan/6.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="camcar/minikhan/7.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
                        </div>
