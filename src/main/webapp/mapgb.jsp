...
<div class="carimage">
    <div class="carimage_img1">
        <img style="width: 100%; height: 100%;" src="chabakmap/gb/gb.jpg" alt="">
    </div>
    <div class="carimage_img2">
        <img style="width: 100%; height: 100%;" src="chabakmap/gb/1.jpeg" alt="">
    </div>
    <div  class="carimage_img3">
        <img style="width: 100%; height: 100%;" src="chabakmap/gb/2.jpeg" alt="">
    </div>
</div>
<div class="carimage2">
    ...
    <div class="carimage2_img5">
        <img style="width: 100%; height: 100%;" src="chabakmap/gb/3.jpeg" alt="">
    ...
    <div class="cartext">
        <div class="carimage_text">
            <h2 style="margin-top: 20px; color: #000000; font-family: 'KOTRA_BOLD-Bold';">나아해변</h2>
        </div>
    ...
    <div class="carlocate">
            <div class="carlocatemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12960.10042284489!2d129.4731731!3d35.7009998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3567b0b083fe4bdb%3A0x7266d9c4ed7d8dfa!2z64KY7JWE7ZW067OA!5e0!3m2!1sko!2skr!4v1692762691552!5m2!1sko!2skr" width="1200" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <p><i class="fa-solid fa-location-dot fa-lg" style="color: #000000;"></i> 대한민국 경주시 양남면 나아해변</p>
        </div>
    </div>
    ...
    <p>https://coolfamily.tistory.com/2174</p>
    <p>https://m.blog.naver.com/jupan1999/221550230459</p>
    <p>https://blog.daum.net/nybog/15730913</p>
    <p>https://kmspapa.tistory.com/115</p>
        </div>
        </div>
     <!-- 모달 -->
                    ...
                    <div id="carouselExample" class="carousel slide" >
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="chabakmap/gb/gb.jpg" class="d-block w-100" alt="Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/gb/1.jpeg" class="d-block w-100" alt="Image 2">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/gb/2.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/gb/3.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
