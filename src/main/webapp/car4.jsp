...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    int carID = 4; // 화면과 연결할 carID 값으로 변경
    ...
    <div class="carimage">
        <div class="carimage_img1">
            <img src="camcar/mrrent/1.jpeg" alt="">
        </div>
        <div class="carimage_img2">
            <img src="camcar/mrrent/2.jpeg" alt="">
        </div>
        <div class="carimage_img3">
            <img src="camcar/mrrent/3.jpeg" alt="">
        </div>
    </div>
    <div class="carimage2">
        ...
        <div class="carimage2_img5">
            <img src="camcar/mrrent/4.jpeg" alt="">
        </div>
        <div class="carimage2_img6">
            <img src="camcar/mrrent/5.jpeg" alt="">
    ...
    <div class="carsection">
        <div class="carsection_text">
            ...
            <p>제일모빌DS9EU+</p>
            <p>5인승6인이상 취침가능!</p>
            <p>노지캠핑에서 3박4일 이상없는 인산철밧데리!</p>

            
            <p><span class="material-symbols-outlined">person</span> 동승가능인원: 5명 <span class="material-symbols-outlined">person</span> 취침가능인원: 6명</p>
            <p><span class="material-symbols-outlined">schedule</span> 대여일 출차시간 08:00 <span class="material-symbols-outlined">schedule</span> 반납일 반납시간 22:00</p>
            ...
            <p><span class="material-symbols-outlined">check</span> 만 21세 이상 <i class="fa-regular fa-address-card"></i> 2종 보통 이상 <span class="material-symbols-outlined">directions_car</span> 운전 경력 1년 이상</p>
            <p><i class="fa-solid fa-location-dot fa-lg" style="color: #000000;"></i> 차고지 주소: 대한민국 충청남도 공주시 신관로 26</p>
            <h2>딜리버리(탁송) 가능지역</h2>
            <p>업체문의</p>
            ...
            <ul class="optionUl">
                ...
                <li><i class="fa-solid fa-baby"></i> <p> 유아용카시트</p></li>
                <li><i class="fa-solid fa-fire"></i> <p> 인덕션</p></li>
            </ul>
            <ul class="optionUl">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="profile-tab-pane1" role="tabpanel" aria-labelledby="profile-tab1" tabindex="1">
                 ...
                 <img src="camcar/mrrent/mr.png" style="width: 100%; height: 100%; margin-top:30px;" alt="">
                  
                  <h2 style="margin-top: 10%">차고지 위치</h2>
    <div class="carlocate" style="width: 602px;height: 520px;">
            <div class="carlocatemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3208.455715477129!2d127.1310565!3d36.4707078!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ab788ac907793%3A0x4a56eb89a653aa66!2z7Lap7LKt64Ko64-EIOqzteyjvOyLnCDsi6DqtIDroZwgMjY!5e0!3m2!1sko!2skr!4v1692719561494!5m2!1sko!2skr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <p style="font-size: 16px; width: 500px;"><i class="fa-solid fa-location-dot fa-lg " style="color: #000000;"></i> 대한민국 충청남도 공주시 신관로 26</p>
        </div>
    </div>
    <div>
    ...
    <div class="carpro">
            <div class="carProfile">
                ...
                <p style="font-size: 16px">엠알렌트카 공주지점 <i class="fa-solid fa-circle-check" style="color: rgb(57, 116, 217);"></i> 인증업체</p>
        </div>
        
        <button style="margin-top: 20px; margin-left: 20px;">엠알렌트카 공주지점에게 채팅하기</button>
    </div>
    ...
    <div style="width: 762px; height: 500px;">
        ...
        <div class="carsection_calendar">
            ...
            <div class="carchat">
                ...
                <p style="text-align: center; margin-top: 10px;" >엠알렌트카 공주지점</p>
                ...
                <div id="carouselExample" class="carousel slide" >
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="camcar/mrrent/1.jpeg" class="d-block w-100" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/mrrent/2.jpeg" class="d-block w-100" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/mrrent/3.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/mrrent/4.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/mrrent/5.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/mrrent/6.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="camcar/mrrent/7.jpeg" class="d-block w-100" alt="Image 3">
                        </div>
                    </div>
