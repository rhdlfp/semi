...
<div class="carimage">
    <div class="carimage_img1">
        <img style="width: 100%; height: 100%;" src="chabakmap/cb/cb.jpg" alt="">
    </div>
    <div class="carimage_img2" style="width:585px;">
        <img style="width: 100%; height: 100%;" src="chabakmap/cb/1.jpeg" alt="">
    </div>
</div>
<div class="carimage2">
    ...
    <div class="carimage2_img5">
        <img style="width: 100%; height: 100%;" src="chabakmap/cb/2.jpeg" alt="">
    ...
    <div class="cartext">
        <div class="carimage_text">
            <h2 style="margin-top: 20px; color: #000000; font-family: 'KOTRA_BOLD-Bold';">충주카누캠핑장</h2>
        </div>
    ...
    <div class="carlocate">
            <div class="carlocatemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3187.425031866827!2d128.02081769999998!3d36.97578659999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35647dcd2ae205ed%3A0x57ec3bc44628e82d!2z7Lap7LKt67aB64-EIOy2qeyjvOyLnCDrj5nrn4nrqbQg7ZmU7JWU66asIDM0MA!5e0!3m2!1sko!2skr!4v1692760177926!5m2!1sko!2skr" width="1200" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <p><i class="fa-solid fa-location-dot fa-lg" style="color: #000000;"></i> 대한민국 충청북도 충주시 동량면 화암리 340</p>
        </div>
    </div>
                    ...
                    <div id="carouselExample" class="carousel slide" >
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="chabakmap/cb/cb.jpg" class="d-block w-100" alt="Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/cb/1.jpeg" class="d-block w-100" alt="Image 2">
                            </div>
                            <div class="carousel-item">
                                <img src="chabakmap/cb/2.jpeg" class="d-block w-100" alt="Image 3">
                            </div>
